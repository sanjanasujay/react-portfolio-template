...
import mock06 from '../assets/images/mock5.png';
...
function Project() {
    ...
    <div className="projects-container" id="projects">
        ...
        <div className="projects-grid">
            ...
            <div className="project">
                <a href="https://github.com/yujisatojr/multi-reg-analysis" target="_blank" rel="noreferrer"><img src={mock04} className="zoom" alt="thumbnail" width="60%"/></a>
             ...
             <div className="project">
              ...
              <h2>Building a machine learning project</h2>
                <p></p>
            </div>
